...
public class MovieScreeningController {
    ...
    public ResponseEntity<MovieScreeningDTO> getScreening(
        @Parameter(description = "ID of the screening to retrieve", example = "11", schema = @Schema(type = "long"))
    ...
    public ResponseEntity<MovieScreeningDTO> createScreening(
        ...
        return ResponseEntity
            ...
            .body(MovieScreeningDTO.fromEntity(
                ...
                new MovieScreening(0, screening.date(), screening.movieName(), screening.cinemaHall())
            )));
    }
